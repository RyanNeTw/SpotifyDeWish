...
<template>
    <header class="flex flex-row justify-between px-20 py-4 bg-stone-800 items-center ">
        <a  href="/" class="text-3xl text-white font-bold">Spotify</a>
        <a href="/login" class="flex flex-row items-center gap-4 slef-center bg-green-800 p-2 rounded hover:bg-green-700 transition ">
